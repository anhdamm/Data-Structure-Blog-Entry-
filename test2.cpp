...
int main(int argc, char **argv) {
	...
	break;
      ...
      case 2:			// Date getters
#if LAB2_TEST2
//            cout << "Testing getters for 9/12/2018: "
//            << " Month = " << present.getMonth() << ", "
//            << " Day = " << present.getDay() << ", "
//            << " Year = " << present.getYear()
//            << endl;
	...
	// Is not a leap year -- std multiple of 4 rule
	    ...
	    cout << "** Incorrectly says 2009 is a leap year." << endl;
	} else {
	    cout << "Correctly says 2009 is NOT a leap year." << endl;
	}
	// Is a leap year -- std multiple of 4 rule
        if(Date::isLeapYear(2020)) {
	    cout << "Correctly says 2020 IS a leap year." << endl;
	} else {
	    cout << "** Incorrectly says 2020 is NOT a leap year." << endl;
	}
	// Is not a leap year -- multiple of 100 rule
        if(Date::isLeapYear(2100)) {
	    cout << "** Incorrectly says 2100 IS a leap year." << endl;
	} else {
	    cout << "Correctly says 2000 is NOT a leap year." << endl;
	}
	// Is a leap year -- multiple of 400 rule
        if(Date::isLeapYear(2400)) {
	    cout << "Correctly says 2400 IS a leap year." << endl;
	} else {
	    cout << "** Incorrectly says 2400 is NOT a leap year." << endl;
	}
	cout << endl;
#else
	inactive_test(selection);
	...
	break;
      ...
      case 4:			// daysInMonth
            ...
            cout << "Feburary 2016 has " << Date::daysInMonth(2, 2016) << " days (29)." << endl;
            cout << "Feburary 2017 has " << Date::daysInMonth(2, 2017) << " days (28)." << endl;
            cout << endl;
//    cout << "Testing < operator" << endl;
